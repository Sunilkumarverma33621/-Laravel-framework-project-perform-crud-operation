...
<table class="table mt-5">
    ...
    <tbody class="text-danger bg-light fs-4">
        ...
        <tr>
            ...
            <td ><img src="images/{{$item['PImage']}}" alt="" width="200px" height="100px"></td>
            <td class="pt-5"><input type="submit" value="Update" class="btn btn-outline-danger rounded-pill" name="update"></td>
            <td class="pt-5"><input type="submit" value="Delete" class="btn btn-outline-danger rounded-pill"></td>
            </form>
